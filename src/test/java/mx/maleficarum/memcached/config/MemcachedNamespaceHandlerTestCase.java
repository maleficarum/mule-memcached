 ...
 */
package mx.maleficarum.memcached.config;

import org.mule.construct.SimpleFlowConstruct;
import org.mule.tck.FunctionalTestCase;

public class MemcachedNamespaceHandlerTestCase extends FunctionalTestCase
{
    @Override
    protected String getConfigResources()
    {
        return"memcached-namespace-config.xml";
    }
    ...
    /*
        ...
        memcached-namespace-config.xml and put the element from your
        cloud connector's namespace that you want to test into it.
        A proper example was put into memcached-namespace-config.xml
